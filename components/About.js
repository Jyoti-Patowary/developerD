            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="md:w-1/2 md:h-1/2">
                        <Image src="https://images.unsplash.com/photo-1680528891514-a046ebfe35e5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDI1fENEd3V3WEpBYkV3fHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=500&q=60" alt="Profile" className="w-50 h-90 mb-6 md:mb-0" />
                    </div>
